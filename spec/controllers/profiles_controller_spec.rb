...
describe ProfilesController do
  ...
  let(:valid_attributes) { { "bio" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested profile" do
        ...
        Profile.any_instance.should_receive(:update_attributes).with({ "bio" => "MyString" })
        put :update, {:id => profile.to_param, :profile => { "bio" => "MyString" }}, valid_session
      end
